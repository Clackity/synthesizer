...
#    if !defined(inline)
#      define DSFMT_inline __inline
#    endif
#  endif
#else
#  include <inttypes.h>
#  if !defined(DSFMT_inline)
#    if defined(__GNUC__)
#      define DSFMT_inline __inline__
#    else
#      define DSFMT_inline
#    endif
#  endif
...
#if defined(__GNUC__)
#  define DSFMT_PRE_INLINE DSFMT_inline static
 ...
 */
DSFMT_inline static uint32_t dsfmt_genrand_uint32(dsfmt_t *dsfmt) {
    uint32_t r;
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_genrand_close1_open2(dsfmt_t *dsfmt) {
    double r;
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static uint32_t dsfmt_gv_genrand_uint32(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_gv_genrand_close1_open2(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_genrand_close_open(dsfmt_t *dsfmt) {
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_gv_genrand_close_open(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_genrand_open_close(dsfmt_t *dsfmt) {
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_gv_genrand_open_close(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_genrand_open_open(dsfmt_t *dsfmt) {
 ...
 * @return double precision floating point pseudorandom number
 */
DSFMT_inline static double dsfmt_gv_genrand_open_open(void) {
 ...
 */
DSFMT_inline static void dsfmt_gv_fill_array_close1_open2(double array[], int size) {
 ...
 */
DSFMT_inline static void dsfmt_gv_fill_array_open_close(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
DSFMT_inline static void dsfmt_gv_fill_array_close_open(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
DSFMT_inline static void dsfmt_gv_fill_array_open_open(double array[], int size) {
 ...
 */
DSFMT_inline static void dsfmt_init_gen_rand(dsfmt_t *dsfmt, uint32_t seed) {
 ...
 */
DSFMT_inline static void dsfmt_gv_init_gen_rand(uint32_t seed) {
 ...
 */
DSFMT_inline static void dsfmt_init_by_array(dsfmt_t *dsfmt, uint32_t init_key[],
				       int key_length) {
 ...
 */
DSFMT_inline static void dsfmt_gv_init_by_array(uint32_t init_key[], int key_length) {
 ...
 */
DSFMT_inline static const char *get_idstring(void) {
 ...
 */
DSFMT_inline static int get_min_array_size(void) {
 ...
 */
DSFMT_inline static void init_gen_rand(uint32_t seed) {
 ...
 */
DSFMT_inline static void init_by_array(uint32_t init_key[], int key_length) {
 ...
 */
DSFMT_inline static double genrand_close1_open2(void) {
 ...
 */
DSFMT_inline static double genrand_close_open(void) {
 ...
 */
DSFMT_inline static double genrand_open_close(void) {
 ...
 */
DSFMT_inline static double genrand_open_open(void) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
DSFMT_inline static void fill_array_open_close(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
DSFMT_inline static void fill_array_close_open(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
DSFMT_inline static void fill_array_open_open(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
DSFMT_inline static void fill_array_close1_open2(double array[], int size) {
